...
(function(global, factory) {
  ...
  function toString(val) {
    return val == null ? '' : typeof val === 'object' ? JSON.stringify(
      val,
      null, 2) : String(val)
  }
  ...
  function bind(fn, ctx) {
    function boundFn(a) {
      ...
      return l ? l > 1 ? fn.apply(ctx, arguments) : fn.call(ctx, a) : fn.call(
        ctx)
    }
...

  {
    ...
    formatComponentName = function(vm, includeFile) {
      ...
      var name = typeof vm === 'string' ? vm : typeof vm === 'function' &&
        vm.options ?
  ...
  strats.data = function(
    ...
    if (!vm) {
      ...
      return function mergedInstanceDataFn() {
        // instance merge
        var instanceData = typeof childVal === 'function' ? childVal.call(
            vm) :
          childVal;
        var defaultData = typeof parentVal === 'function' ? parentVal
          .call(vm) :
          undefined;
        if (instanceData) {
  ...
  function mergeHook(
    ...
    return childVal ? parentVal ? parentVal.concat(childVal) : Array.isArray(
      childVal) ? childVal : [childVal] : parentVal
  }
  ...
  function validateProp(
    ...
    if (isType(Boolean, prop.type)) {
      if (absent && !hasOwn(prop, 'default')) {
        value = false;
      } else if (!isType(String, prop.type) && (value === '' || value ===
          hyphenate(key))) {
        value = true;
      }
    }
  ...
  function normalizeChildren(children) {
    return isPrimitive(children) ? [createTextVNode(children)] : Array.isArray(
      children) ? normalizeArrayChildren(children) : undefined
  }
  ...
  function resolveSlots(
    ...
    for (var i = 0, l = children.length; i < l; i++) {
      ...
      // same context.
      if ((child.context === context || child.functionalContext ===
          context) &&
        ...
        if (circular[id] > MAX_UPDATE_COUNT) {
          warn(
            'You may have an infinite update loop ' + (
              watcher.user ? ("in watcher with expression \"" + (
                  watcher.expression) +
  ...
  function defineComputed(target, key, userDef) {
    if (typeof userDef === 'function') {
      ...
      sharedPropertyDefinition.get = userDef.get ? userDef.cache !==
        false ?
  ...
  function createComputedGetter(key) {
    return function computedGetter() {
      var watcher = this._computedWatchers && this._computedWatchers[
        key];
      if (watcher) {
        if (watcher.dirty) {
          watcher.evaluate();
  ...
  function initProvide(vm) {
    ...
    if (provide) {
      vm._provided = typeof provide === 'function' ? provide.call(vm) :
        provide;
    }
  }
  ...
  function resolveInject(inject, vm) {
    if (inject) {
      ...
      var keys = isArray ? inject : hasSymbol ? Reflect.ownKeys(inject) :
        Object.keys(inject);
  ...
  function _createElement(
    ...
    if (typeof tag === 'string') {
      ...
      } else if (isDef(Ctor = resolveAsset(context.$options, 'components',
          tag))) {
        // component
      ...
      if (!isObject(value)) {
        ...
        for (var key in value) {
          if (key === 'class' || key === 'style') {
            ...
            hash = asProp || config.mustUseProp(tag, type, key) ? data.domProps ||
              (data.domProps = {}) : data.attrs || (data.attrs = {});
          }
          if (!(key in hash)) {
            hash[key] = value[key];
          }
  ...
  function renderMixin(Vue) {
    ...
    Vue.prototype._render = function() {
      ...
      try {
        ...
        /* istanbul ignore else */
        {
          vnode = vm.$options.renderError ? vm.$options.renderError.call(
            vm._renderProxy,
            vm.$createElement, e) : vm._vnode;
        }
      }
  ...
  function createElement$1(tagName, vnode) {
    ...
    if (vnode.data && vnode.data.attrs && vnode.data.attrs.multiple !==
      undefined) {
      ...
      if (isDef(tag)) {
        {
          ...
          if (!inPre &&
            !vnode.ns &&
            !(config.ignoredElements.length && config.ignoredElements.indexOf(
                tag) >
              -1) &&
    ...
    function updateChildren(parentElm, oldCh, newCh, insertedVnodeQueue,
      ...
      while (oldStartIdx <= oldEndIdx && newStartIdx <= newEndIdx) {
        if (isUndef(oldStartVnode)) {
          ...
          idxInOld = isDef(newStartVnode.key) ? oldKeyToIdx[newStartVnode
              .key] :
            null;
      ...
      mergeVNodeHook(vnode.data.hook || (vnode.data.hook = {}),
        ...
        function() {
          for (var i = 0; i < dirsWithPostpatch.length; i++) {
            callHook$1(dirsWithPostpatch[i], 'componentUpdated', vnode,
              oldVnode);
          }
        });
    }
  ...
  function genDefaultModel(
    ...
    var event = lazy ? 'change' : type === 'range' ? RANGE_TOKEN :
      'input';
  ...
  function add$1(
    ...
    if (once$$1) {
      ...
      handler = function(ev) {
        var res = arguments.length === 1 ? oldHandler(ev) : oldHandler.apply(
          null, arguments);
        if (res !== null) {
  ...
  function updateStyle(oldVnode, vnode) {
    ...
    // to mutate it.
    vnode.data.normalizedStyle = isDef(style.__ob__) ? extend({}, style) :
      style;
  ...
  var raf = inBrowser && window.requestAnimationFrame ? window.requestAnimationFrame
  ...
  function whenTransitionEnds(
    ...
    var event = type === TRANSITION ? transitionEndEvent :
      animationEndEvent;
    var ended = 0;
    var end = function() {
  ...
  function getTransitionInfo(el, expectedType) {
    ...
    if (expectedType === TRANSITION) {
      ...
      type = timeout > 0 ? transitionTimeout > animationTimeout ?
        TRANSITION :
        ANIMATION : null;
      propCount = type ? type === TRANSITION ? transitionDurations.length :
  ...
  function enter(vnode, toggleDisplay) {
    ...
    var activeClass = isAppear && appearActiveClass ? appearActiveClass :
      enterActiveClass;
    var toClass = isAppear && appearToClass ? appearToClass :
      enterToClass;

    var beforeEnterHook = isAppear ? (beforeAppear || beforeEnter) :
      beforeEnter;
    var enterHook = isAppear ? (typeof appear === 'function' ? appear :
        enter) :
      enter;
    ...
    if (!vnode.data.show) {
      ...
      mergeVNodeHook(vnode.data.hook || (vnode.data.hook = {}), 'insert',
        function() {
          ...
          var pendingNode = parent && parent._pending && parent._pending[
            vnode.key];
          if (pendingNode &&
  ...
  var Transition = {
    ...
    render: function render(h) {
      ...
      child.key = child.key == null ? id + child.tag : isPrimitive(
          child.key) ?
        (String(child.key).indexOf(id) === 0 ? child.key : id + child
          .key) :
        child.key;
  ...
  var TransitionGroup = {
    ...
    updated: function updated() {
      ...
      if (!children.length || !this.hasMove(children[0].elm,
          moveClass)) {
        return
      }
  ...
  function applyTranslation(c) {
    ...
    if (dx || dy) {
      c.data.moved = true;
      var s = c.elm.style;
      s.transform = s.WebkitTransform = "translate(" + dx + "px," + dy +
        "px)";
  ...
  function parseHTML(html, options) {
    ...
    while (html) {
      ...
      if (!lastTag || !isPlainTextElement(lastTag)) {
        ...
        var reStackedTag = reCache[stackedTag] || (reCache[stackedTag] =
          new RegExp(
            '([\\s\\S]*?)(</' + stackedTag + '[^>]*>)', 'i'));
        var endTagLength = 0;
    ...
    function handleStartTag(match) {
      ...
      var unary = isUnaryTag$$1(tagName) || tagName === 'html' && lastTag ===
        'head' || !!unarySlash;
  ...
  function parse(
    ...
    parseHTML(template, {
      ...
      chars: function chars(text) {
        ...
        if (text) {
          var expression;
          if (!inVPre && text !== ' ' && (expression = parseText(
              text,
              delimiters))) {
            children.push({
              type: 2,
          ...
          } else if (text !== ' ' || !children.length || children[
              children.length -
              1].text !== ' ') {
            children.push({
              type: 3,
    ...
    for (i = 0, l = list.length; i < l; i++) {
      ...
      if (dirRE.test(name)) {
        ...
        if (bindRE.test(name)) { // v-bind
          ...
          if (isProp || platformMustUseProp(el.tag, el.attrsMap.type,
              name)) {
  ...
  function genHandler(
    ...
    if (!handler.modifiers) {
      return isMethodPath || isFunctionExpression ? handler.value : (
      ...
      var handlerCode = isMethodPath ? handler.value + '($event)' :
        isFunctionExpression ? ("(" + (handler.value) + ")($event)") :
        handler.value;
  ...
  function genOnce(el) {
    ...
    if (el.if && !el.ifProcessed) {
      ...
      return ("_o(" + (genElement(el)) + "," + (onceCount++) + (key ? (
        "," +
        key) : "") + ")")
    } else {
      return genStatic(el)
  ...
  function genData(el) {
    ...
    // component v-model
    if (el.model) {
      data += "model:{value:" + (el.model.value) + ",callback:" + (el.model
          .callback) +
  ...
  function genInlineTemplate(el) {
    ...
    if (ast.type === 1) {
      ...
      return ("inlineTemplate:{render:function(){" + (inlineRenderFns.render) +
        "},staticRenderFns:[" + (inlineRenderFns.staticRenderFns.map(
          function(
            code) {
  ...
  function genScopedSlot(key, el) {
    ...
    return "{key:" + key + ",fn:function(" + (String(el.attrsMap.scope)) +
      "){" +
      "return " + (el.tag === 'template' ? genChildren(el) || 'void 0' :
        genElement(el)) + "}}"
  }
  ...
  function genChildren(el, checkSkip) {
    ...
    if (children.length) {
      ...
      var normalizationType = checkSkip ? getNormalizationType(children) :
        0;
  ...
  function genComponent(componentName, el) {
    var children = el.inlineTemplate ? null : genChildren(el, true);
    return ("_c(" + componentName + "," + (genData(el)) + (children ? (
      "," +
      children) : '') + ")")
  }
  ...
  var mapState = normalizeNamespace(function(namespace, states) {
    ...
    normalizeMap(states).forEach(function(ref) {
      ...
      res[key] = function mappedState() {
        ...
        return typeof val === 'function' ? val.call(this, state,
            getters) :
          state[val]
      };
  ...
  var mapMutations = normalizeNamespace(function(namespace, mutations) {
    ...
    normalizeMap(mutations).forEach(function(ref) {
      ...
      res[key] = function mappedMutation() {
        ...
        return this.$store.commit.apply(this.$store, [val].concat(
          args))
      };
    });
    return res
  ...
  var mapActions = normalizeNamespace(function(namespace, actions) {
    ...
    normalizeMap(actions).forEach(function(ref) {
      ...
      res[key] = function mappedAction() {
        ...
        return this.$store.dispatch.apply(this.$store, [val].concat(
          args))
      };
    });
    return res
...
(function(global, factory) {
  ...
  function warn(condition, message) {
    if ("development" !== 'production' && !condition) {
      typeof console !== 'undefined' && console.warn(("[vue-router] " +
        message));
    }
  }
  ...
  var View = {
    ...
    render: function render(_, ref) {
      ...
      // resolve props
      data.props = resolveProps(route, matched.props && matched.props[
        name]);
  ...
  function isSameRoute(a, b) {
    if (b === START) {
      ...
      return (
        a.path.replace(trailingSlashRE, '') === b.path.replace(
          trailingSlashRE,
          '') &&
        a.hash === b.hash &&
  ...
  var Link = {
    ...
    render: function render(h) {
      ...
      var activeClassFallback = globalActiveClass == null ?
        'router-link-active' : globalActiveClass;
      var exactActiveClassFallback = globalExactActiveClass == null ?
        'router-link-exact-active' : globalExactActiveClass;
      var activeClass = this.activeClass == null ?
        activeClassFallback : this
        .activeClass;
      var exactActiveClass = this.exactActiveClass == null ?
        exactActiveClassFallback : this.exactActiveClass;
      var compareTarget = location.path ? createRoute(null, location,
        null,
        router) : route;

      classes[exactActiveClass] = isSameRoute(current, compareTarget);
      classes[activeClass] = this.exact ? classes[exactActiveClass] :
  ...
  function tokensToFunction(tokens) {
    ...
    return function(obj, opts) {
      ...
      var data = obj || {};
      var options = opts || {};
      var encode = options.pretty ? encodeURIComponentPretty :
        encodeURIComponent;
      ...
      for (var i = 0; i < tokens.length; i++) {
        ...
        if (value == null) {
          if (token.optional) {
            ...
            throw new TypeError('Expected "' + token.name +
              '" to be defined')
          }
        }
        ...
        if (index$1(value)) {
          if (!token.repeat) {
            throw new TypeError('Expected "' + token.name +
              '" to not repeat, but received `' + JSON.stringify(
                value) + '`')
          }
          ...
          for (var j = 0; j < value.length; j++) {
            ...
            if (!matches[i].test(segment)) {
              throw new TypeError('Expected all "' + token.name +
                '" to match "' +
                token.pattern + '", but received `' + JSON.stringify(
                  segment) +
                '`')
            }

            path += (j === 0 ? token.prefix : token.delimiter) +
              segment;
          }
  ...
  function tokensToRegExp(tokens, keys, options) {
    ...
    if (!strict) {
      route = (endsWithDelimiter ? route.slice(0, -delimiter.length) :
          route) +
        '(?:' + delimiter + '(?=$))?';
    }
  ...
  function pathToRegexp(path, keys, options) {
    ...
    if (index$1(path)) {
      return arrayToRegexp( /** @type {!Array} */ (path), /** @type {!Array} */ (
        keys), options)
    }

    return stringToRegexp( /** @type {string} */ (path), /** @type {!Array} */ (
      keys), options)
  }
  ...
  function addRouteRecord(
    ...
    var name = route.name; {
      ...
      assert(
        ...
        "route config \"component\" for path: " + (String(path || name)) +
        " cannot be a " +
    ...
    if (route.children) {
      ...
      route.children.forEach(function(child) {
        var childMatchAs = matchAs ? cleanPath((matchAs + "/" + (
            child.path))) :
          undefined;
    ...
    if (route.alias !== undefined) {
      if (Array.isArray(route.alias)) {
        route.alias.forEach(function(alias) {
          ...
          addRouteRecord(pathList, pathMap, nameMap, aliasRoute,
            parent, record
            .path);
        });
      } else {
  ...
  function normalizeLocation(
    ...
    var path = parsedPath.path ? resolvePath(parsedPath.path, basePath,
      append ||
      next.append) : basePath;
  ...
  function createMatcher(
    ...
    function redirect(
      ...
      var redirect = typeof originalRedirect === 'function' ?
        originalRedirect(
          createRoute(record, location, null, router)) : originalRedirect;
      ...
      if (!redirect || typeof redirect !== 'object') {
        {
          warn(
            false, ("invalid redirect option: " + (JSON.stringify(
              redirect)))
          );
        }
        return _createRoute(null, location)
      ...
      if (name) {
        ...
        var targetRecord = nameMap[name]; {
          assert(targetRecord, ("redirect failed: named route \"" + name +
            "\" not found."));
        }
        return match({
          _normalized: true,
        ...
        {
          warn(false, ("invalid redirect option: " + (JSON.stringify(
            redirect))));
        }
        return _createRoute(null, location)
      }
  ...
  function resolveRecordPath(path, record) {
    return resolvePath(path, record.parent ? record.parent.path : '/',
      true)
  }
  ...
  function handleScroll(
    ...
    {
      assert(typeof behavior === 'function',
  ...
  var supportsPushState = inBrowser && (function() {
    ...
    if (
      (ua.indexOf('Android 2.') !== -1 || ua.indexOf('Android 4.0') !==
        -1) &&
  ...
  History.prototype.confirmTransition = function confirmTransition(route,
    ...
    runQueue(queue, iterator, function() {
      ...
      var enterGuards = extractEnterGuards(activated, postEnterCbs,
        isValid);
  ...
  function extractGuards(
    ...
    var guards = flatMapComponents(records, function(def, instance, match,
      key) {
  ...
  function extractEnterGuards(
    ...
    return extractGuards(activated, 'beforeRouteEnter', function(guard, _,
      match, key) {
    ...
    return function(to, from, next) {
      ...
      flatMapComponents(matched, function(def, _, match, key) {
        ...
        if (typeof def === 'function' && def.cid === undefined) {
          ...
          var reject = once(function(reason) {
            var msg = "Failed to resolve async component " +
              key + ": " +
              reason;
  ...
  var HTML5History = (function(History$$1) {
    function HTML5History(router, base) {
      ...
      window.addEventListener('popstate', function(e) {
        this$1.transitionTo(getLocation(this$1.base), function(
          route) {
          if (expectScroll) {
    ...
    HTML5History.prototype.push = function push(location, onComplete,
      onAbort) {
      var this$1 = this;
  ...
  var HashHistory = (function(History$$1) {
    ...
    HashHistory.prototype.push = function push(location, onComplete,
      onAbort) {
      this.transitionTo(location, function(route) {
  ...
  var AbstractHistory = (function(History$$1) {
    ...
    AbstractHistory.prototype = Object.create(History$$1 &&
      History$$1.prototype);
    ...
    AbstractHistory.prototype.push = function push(location,
      ...
      this.transitionTo(location, function(route) {
        this$1.stack = this$1.stack.slice(0, this$1.index + 1).concat(
          route);
        this$1.index++;
        onComplete && onComplete(route);
      }, onAbort);
    ...
    AbstractHistory.prototype.replace = function replace(location,
      ...
      this.transitionTo(location, function(route) {
        this$1.stack = this$1.stack.slice(0, this$1.index).concat(
          route);
        onComplete && onComplete(route);
      }, onAbort);
    };
  ...
  VueRouter.prototype.replace = function replace(location, onComplete,
    onAbort) {
    ...
    ([
        ...
        (function(Buffer) {
          ...
          function merge( /* obj1, obj2, obj3, ... */ ) {
            ...
            function assignValue(val, key) {
              if (typeof result[key] === 'object' && typeof val ===
                'object') {
      ...
      function(module, exports, __webpack_require__) {
        ...
        (function(global) {
          ...
          Buffer.TYPED_ARRAY_SUPPORT = global.TYPED_ARRAY_SUPPORT !==
            undefined ?
            global.TYPED_ARRAY_SUPPORT : typedArraySupport()
          ...
          function from(that, value, encodingOrOffset, length) {
            ...
            if (typeof ArrayBuffer !== 'undefined' && value instanceof ArrayBuffer) {
              return fromArrayBuffer(that, value, encodingOrOffset,
                length)
            }
          ...
          function alloc(that, size, fill, encoding) {
            ...
            if (fill !== undefined) {
              ...
              return typeof encoding === 'string' ? createBuffer(that,
                size).fill(
                fill, encoding) : createBuffer(that, size).fill(fill)
            }
            return createBuffer(that, size)
          }
          ...
          function slowToString(encoding, start, end) {
            ...
            while (true) {
              switch (encoding) {
                ...
                default:
                  if (loweredCase) throw new TypeError(
                    'Unknown encoding: ' +
                    encoding)
                  encoding = (encoding + '').toLowerCase()
                  loweredCase = true
          ...
          Buffer.prototype.toString = function toString() {
            ...
            if (length === 0) return ''
            if (arguments.length === 0) return utf8Slice(this, 0,
              length)
          ...
          Buffer.prototype.compare = function compare(target, start, end,
            ...
            if (start < 0 || end > target.length || thisStart < 0 ||
              thisEnd >
              this.length) {
          ...
          function bidirectionalIndexOf(buffer, val, byteOffset, encoding,
            dir) {
            ...
            if (Buffer.isBuffer(val)) {
              ...
              return arrayIndexOf(buffer, [val], byteOffset, encoding,
                dir)
            }
          ...
          function arrayIndexOf(arr, val, byteOffset, encoding, dir) {
            ...
            if (dir) {
              ...
              if (byteOffset + valLength > arrLength) byteOffset =
                arrLength -
                valLength
          ...
          function hexWrite(buf, string, offset, length) {
            ...
            if (strLen % 2 !== 0) throw new TypeError(
              'Invalid hex string')
          ...
          function ucs2Write(buf, string, offset, length) {
            return blitBuffer(utf16leToBytes(string, buf.length - offset),
              buf,
              offset, length)
          }
          ...
          Buffer.prototype.write = function write(string, offset, length,
            ...
            } else if (length === undefined && typeof offset ===
              'string') {
              encoding = offset
              length = this.length
              offset = 0
          ...
          function utf8Slice(buf, start, end) {
            ...
            while (i < end) {
              var firstByte = buf[i]
              var codePoint = null
              var bytesPerSequence = (firstByte > 0xEF) ? 4 : (firstByte >
                  0xDF) ?
                  ...
                  case 4:
                    ...
                    if ((secondByte & 0xC0) === 0x80 && (thirdByte & 0xC0) ===
                      ...
                      tempCodePoint = (firstByte & 0xF) << 0x12 | (
                          secondByte & 0x3F) <<
                        0xC | (thirdByte & 0x3F) << 0x6 | (fourthByte &
                          0x3F)
          ...
          Buffer.prototype.readUIntBE = function readUIntBE(offset,
            byteLength,
            noAssert) {
            offset = offset | 0
            byteLength = byteLength | 0
          ...
          Buffer.prototype.readIntLE = function readIntLE(offset,
            byteLength,
            noAssert) {
            offset = offset | 0
            byteLength = byteLength | 0
          ...
          Buffer.prototype.readIntBE = function readIntBE(offset,
            byteLength,
            noAssert) {
            offset = offset | 0
            byteLength = byteLength | 0
          ...
          Buffer.prototype.writeUIntLE = function writeUIntLE(value,
            offset,
            byteLength, noAssert) {
            value = +value
            offset = offset | 0
          ...
          function objectWriteUInt16(buf, value, offset, littleEndian) {
            ...
            for (var i = 0, j = Math.min(buf.length - offset, 2); i < j; ++
              i) {
              buf[offset + i] = (value & (0xff << (8 * (littleEndian ? i :
                  1 - i)))) >>>
          ...
          Buffer.prototype.writeUInt16BE = function writeUInt16BE(value,
            offset,
            noAssert) {
            value = +value
            offset = offset | 0
          ...
          function objectWriteUInt32(buf, value, offset, littleEndian) {
            ...
            for (var i = 0, j = Math.min(buf.length - offset, 4); i < j; ++
              i) {
          ...
          Buffer.prototype.writeUInt32LE = function writeUInt32LE(value,
            offset,
            noAssert) {
            value = +value
            offset = offset | 0
          ...
          Buffer.prototype.writeUInt32BE = function writeUInt32BE(value,
            offset,
            noAssert) {
            value = +value
            offset = offset | 0
          ...
          Buffer.prototype.writeInt16LE = function writeInt16LE(value,
            offset,
            noAssert) {
            value = +value
            offset = offset | 0
          ...
          Buffer.prototype.writeInt16BE = function writeInt16BE(value,
            offset,
            noAssert) {
            value = +value
            offset = offset | 0
          ...
          Buffer.prototype.writeInt32LE = function writeInt32LE(value,
            offset,
            noAssert) {
            value = +value
            offset = offset | 0
          ...
          Buffer.prototype.writeInt32BE = function writeInt32BE(value,
            offset,
            noAssert) {
            value = +value
            offset = offset | 0
          ...
          Buffer.prototype.writeFloatLE = function writeFloatLE(value,
            offset,
            noAssert) {
            return writeFloat(this, value, offset, true, noAssert)
          }

          Buffer.prototype.writeFloatBE = function writeFloatBE(value,
            offset,
            noAssert) {
          ...
          Buffer.prototype.writeDoubleLE = function writeDoubleLE(value,
            offset,
            noAssert) {
            return writeDouble(this, value, offset, true, noAssert)
          }

          Buffer.prototype.writeDoubleBE = function writeDoubleBE(value,
            offset,
            noAssert) {
          ...
          Buffer.prototype.copy = function copy(target, targetStart,
            start, end) {
            if (!start) start = 0
          ...
          Buffer.prototype.fill = function fill(val, start, end, encoding) {
            ...
            if (typeof val === 'string') {
              ...
              if (encoding !== undefined && typeof encoding !==
                'string') {
                throw new TypeError('encoding must be a string')
              }
              if (typeof encoding === 'string' && !Buffer.isEncoding(
                  encoding)) {
            ...
            if (typeof val === 'number') {
              ...
              var bytes = Buffer.isBuffer(val) ? val : utf8ToBytes(new Buffer(
                val,
                encoding).toString())
          ...
          function utf8ToBytes(string, units) {
            ...
            for (var i = 0; i < length; ++i) {
              ...
              if (codePoint > 0xD7FF && codePoint < 0xE000) {
                ...
                codePoint = (leadSurrogate - 0xD800 << 10 | codePoint -
                    0xDC00) +
                  0x10000
      ...
      function(module, exports) {
        ...
        exports.read = function(buffer, offset, isLE, mLen, nBytes) {
          ...
          e >>= (-nBits)
          nBits += mLen
          for (; nBits > 0; m = m * 256 + buffer[offset + i], i += d,
            nBits -= 8) {}
        ...
        exports.write = function(buffer, value, offset, isLE, mLen, nBytes) {
          ...
          for (; mLen >= 8; buffer[offset + i] = m & 0xff, i += d, m /=
            256, mLen -=
            8) {}

          e = (e << mLen) | m
          eLen += mLen
          for (; eLen > 0; buffer[offset + i] = e & 0xff, i += d, e /=
            256, eLen -=
            8) {}
      ...
      function(module, exports, __webpack_require__) {
        ...
        function setContentTypeIfUnset(headers, value) {
          if (!utils.isUndefined(headers) && utils.isUndefined(headers[
              'Content-Type'])) {
      ...
      function(module, exports, __webpack_require__) {
        ...
        module.exports = function normalizeHeaderName(headers,
          normalizedName) {
      ...
      function(module, exports, __webpack_require__) {
        ...
        var btoa = (typeof window !== 'undefined' && window.btoa && window.btoa
          .bind(
        ...
        module.exports = function xhrAdapter(config) {
          return new Promise(function dispatchXhrRequest(resolve, reject) {
            ...
            // Handle timeout
            request.ontimeout = function handleTimeout() {
              reject(createError('timeout of ' + config.timeout +
                'ms exceeded',
                config, 'ECONNABORTED'));
      ...
      function(module, exports, __webpack_require__) {
        ...
        module.exports = function settle(resolve, reject, response) {
          ...
          if (!response.status || !validateStatus || validateStatus(
              response.status)) {
            resolve(response);
          } else {
            reject(createError(
      ...
      function(module, exports, __webpack_require__) {
        ...
        module.exports = function parseHeaders(headers) {
          ...
          utils.forEach(headers.split('\n'), function parser(line) {
            ...
            if (key) {
              parsed[key] = parsed[key] ? parsed[key] + ', ' + val :
                val;
            }
          });
        ...
        module.exports = (
          ...
          (function standardBrowserEnv() {
            ...
            return function isURLSameOrigin(requestURL) {
              var parsed = (utils.isString(requestURL)) ? resolveURL(
                  requestURL) :
                requestURL;
...
(function(global, factory) {
  ...
  var Sizzle =
    ...
    (function(window) {
          ...
          if (documentIsHTML) {
            ...
            if (support.qsa &&
              ...
              if (nodeType !== 1) {
                ...
                newContext = rsibling.test(selector) && testContext(context
                    .parentNode) ||
                  context;
              }
      ...
      select = Sizzle.select = function(selector, context, results, seed) {
        ...
        if (match.length === 1) {
          ...
          if (tokens.length > 2 && (token = tokens[0]).type === "ID" &&
            context.nodeType === 9 && documentIsHTML && Expr.relative[
              tokens[1].type]
          ) {
        ...
        (compiled || compile(selector, match))(
          ...
          results, !context || rsibling.test(selector) && testContext(
            context.parentNode) ||
          context
        );
        return results;
      ...
      support.sortDetached = assert(function(el) {
        ...
        return el.compareDocumentPosition(document.createElement(
            "fieldset")) &
          1;
      });
      ...
      // count of uncompleted subordinates
        ...
        updateFunc = function(i) {
          return function(value) {
            ...
            resolveValues[i] = arguments.length > 1 ? slice.call(
                arguments) :
              value;
            if (!(--remaining)) {
  ...
  function setGlobalEval(elems, refElements) {
    ...
    for (; i < l; i++) {
      dataPriv.set(
        elems[i],
        "globalEval", !refElements || dataPriv.get(refElements[i],
          "globalEval")
      );
    }
  }
      ...
      get: function(elem, computed, extra) {
        if (computed) {
          ...
          return rdisplayswap.test(jQuery.css(elem, "display")) &&
            ...
            (!elem.getClientRects().length || !elem.getBoundingClientRect()
              .width) ?
            ...
            return function() {
              if (callback) {
                callback = errorCallback = xhr.onload =
                  xhr.onerror = xhr.onabort = xhr.onreadystatechange =
                  null;
